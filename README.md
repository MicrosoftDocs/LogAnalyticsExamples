...
If you submit a pull request with new or significant changes, and you are not an employee of Microsoft, we'll send a comment in GitHub asking you to submit an online Contribution License Agreement [CLA](https://cla.microsoft.com). We'll need you to complete the online form before we can accept your pull request.
